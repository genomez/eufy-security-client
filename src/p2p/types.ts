...
export enum CommandType {
  ...
  /** T9000 HomeBase S1 grid/device state notify (nested inside CMD_NOTIFY_PAYLOAD JSON). */
  CMD_HOME_BASE_S1_GRID_UPDATE = 9243,
  ...
  CMD_STATION_PUSH_NOTIFY = 1317,
  CMD_STATION_PUSH_NOTIFY_ALT = 1318,
